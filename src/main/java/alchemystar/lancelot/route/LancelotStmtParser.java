...
public class LancelotStmtParser {
	...
	public static RouteResultset singleParse(String sql) {
		RouteResultset routeResultset = new RouteResultset();
		RouteResultsetNode[] nodes = new RouteResultsetNode[1];
		RouteResultsetNode node = new RouteResultsetNode(String.valueOf(1), sql, ServerParse.SELECT);
		nodes[0] = node;
		routeResultset.setNodes(nodes);
		return routeResultset;
	}
